...
my %inflections = ("NOM", {"0", "nolla", "1", "yksi", "2", "kaksi",
       ...
       "ELA", {"1", "yhdestä", "2", "kahdesta", "3",
         "kolmesta", "4", "neljästä", "5",
         "viidestä", "6", "kuudesta", "7",
         "seitsemästä", "8", "kahdeksasta", "9",
         "yhdeksästä", "o", "toista", "k",
         "kymmenestä", "s", "sadasta", "t",
         "tuhannesta", "m", "miljoonasta", "r",
         "miljardista", "b", "biljoonasta" },
...
sub convert {
    ...
    $number =~ s/(\d+)\#([A-Z]+)/$1/g;
    my $form = $2;
    $form = "NOM" if ($form eq "" or not exists $inflections{$form} );
